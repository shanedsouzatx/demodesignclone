  ...
  return (
    <div className="max-w-8xl mx-auto overflow-x-auto pt-[390px] lg:pt-[240px] p-6 px-11 ">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start gap-9 md:mt-11 xl:-mt-11 ">
        <div className="md:w-2/5">
          ...
          <p className="text-gray-800 mt-3 ">
            ...
            Behavioral Health Services (IBHS). Our approach is rooted in comprehensive 
            assessments of each child’s behavior and environment, allowing us to 
            develop precise intervention plans aimed at achieving tangible goals.
          </p>
        </div>
      ...
      <div className="flex flex-col md:flex-row justify-between items-start gap-9 md:-mt-80 -mt-[10px] lg:-mt-[530px] ">
        <div className="md:w-2/5">
          <h2 className="text-3xl pt-9 font-bold text-black">Program Proposal</h2>
          <p className="text-gray-800 mt-2">
