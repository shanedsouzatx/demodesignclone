...
export default function Benefits() {
  return (
   ...
   <h2 className="text-xl md:text-2xl font-bold text-blue-500    ">Benefits of Working with Us
     ...
     <h1 className="text-blue-500 text-xl sm:text-2xl md:text-3xl  font-bold pt-16">Apply to work for us here.</h1>
  <button className="bg-blue-500 text-black  px-4 py-2 mt-3 rounded-md">
    <Link href="/job-application">   Sign Up  </Link>
   </button>
  ...
  <p className="text-gray-600 mt-2">If you want to get BATP’s help for your family
     ...
     <Link href="/contact-us" className="text-blue-500 font-bold hover:text-gray-600"> Contact Us. </Link>

</p>
<p className="text-gray-600 mt-2">If you want to join the BATP team please
    
    <Link href="/job-application" className="text-blue-500  hover:text-gray-600"> Click Here </Link>
